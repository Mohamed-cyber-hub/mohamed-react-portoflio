    ...
    return (
        ...
        <ul>
            ...
            <li
                key={id}
                className={
                "flex justify-between items-center w-40 h-14 px-4 ml-[-100px] hover:ml-[-10px] hover:rounded-md duration-300 bg-gradient-to-r from-[#10403B] via-[#637371] to-[#BFBFBF]" +
                " " +
                style
                }
            >
